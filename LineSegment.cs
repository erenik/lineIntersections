/**
	Emil Hedemalm
	2021-02-26
	LineSegment and intersection checks, mainly ported from the C++ game engine work, with a small modification 
	of adding a Axis-aligned Bounding-box check to the beginning of the intersection function.
	https://github.com/erenik/engine/blob/master/src/PhysicsLib/Shapes/LineSegment.cpp#L72
...
struct LineSegment
{
	public LineSegment(Point start, Point stop)
	{
		this.Start = start;
		this.Stop = stop;
	}
	...
	public Intersection Intersects(LineSegment otherLine)
	{
